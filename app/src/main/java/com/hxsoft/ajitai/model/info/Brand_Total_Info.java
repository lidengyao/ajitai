...
public class Brand_Total_Info implements Serializable {
        ...
        private ArrayList<Brand_Info> data;
        ...
        public ArrayList<Brand_Info> getData() {
            return data;
        }

        public void setData(ArrayList<Brand_Info> data) {
            this.data = data;
        }
