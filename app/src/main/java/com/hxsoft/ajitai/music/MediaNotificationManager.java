...
package com.hxsoft.ajitai.music;
...
import com.hxsoft.ajitai.music.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private static final String CHANNEL_ID = "com.hxsoft.ajitai.music.MUSIC_CHANNEL_ID";

    private static final int NOTIFICATION_ID = 412;
    private static final int REQUEST_CODE = 100;

    public static final String ACTION_PAUSE = "com.hxsoft.ajitai.music.pause";
    public static final String ACTION_PLAY = "com.hxsoft.ajitai.music.play";
    public static final String ACTION_PREV = "com.hxsoft.ajitai.music.prev";
    public static final String ACTION_NEXT = "com.hxsoft.ajitai.music.next";
    public static final String ACTION_STOP = "com.hxsoft.ajitai.music.stop";
    public static final String ACTION_STOP_CASTING = "com.hxsoft.ajitai.music.stop_cast";
    ...
    private PendingIntent createContentIntent(MediaDescriptionCompat description) {
        Intent openUI = new Intent(mService, A_Activity_YinYue.class);
        openUI.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        openUI.putExtra(A_Activity_YinYue.EXTRA_START_FULLSCREEN, true);
        if (description != null) {
            openUI.putExtra(A_Activity_YinYue.EXTRA_CURRENT_MEDIA_DESCRIPTION, description);
        }
