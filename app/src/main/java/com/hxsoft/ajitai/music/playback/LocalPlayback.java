 ...
 */
package com.hxsoft.ajitai.music.playback;
...
import com.hxsoft.ajitai.music.model.MusicProviderSource;
...
public final class LocalPlayback implements Playback {
    ...
    public void play(QueueItem item) {
        ...
        if (mediaHasChanged || mExoPlayer == null) {
            ...
            //获取音乐资源的路径
            @SuppressLint("WrongConstant") String source = track.getString(MusicProviderSource.CUSTOM_METADATA_TRACK_SOURCE);
            if (source != null) {
