...
import com.hxsoft.ajitai.utils.QuestionType;
...
public class JianChaAdapter extends CommonAdapter<JianChaInfo.RecordsBean> {
    ...
    public void convert(int position, ViewHolder helper, JianChaInfo.RecordsBean item) {
        ...
        RequestOptions options = new RequestOptions()
                .placeholder(R.mipmap.jiazaiing)//图片加载出来前，显示的图片
                .fallback(R.mipmap.jiazaiing) //url为空的时候,显示的图片
                .error(R.mipmap.jiazaiing);//图片加载失败后，显示的图片
