 ...
 */
public class A_Cvideocomment_Adapter extends CommonAdapter<A_Cvideocomment_Info> {

    private Context _Context;
    private Integer _type;

    public A_Cvideocomment_Adapter(Context context, List<A_Cvideocomment_Info> data, int itemLayoutId, Integer type) {
    ...
    @Override
    public void convert(int position, ViewHolder helper, A_Cvideocomment_Info item) {
