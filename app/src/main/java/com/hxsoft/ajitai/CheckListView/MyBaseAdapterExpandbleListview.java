...
public abstract class MyBaseAdapterExpandbleListview<T>  extends BaseExpandableListAdapter {
    ...
    public MyBaseAdapterExpandbleListview(Context context, List<T> datasParent, List<T> datasChild, int layoutIdParent, int layoutIdChild, boolean isReUse) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        MyViewHolderExpandbleListView holder = MyViewHolderExpandbleListView.get(mContext,view,viewGroup,mLayoutIdParent,i,mIsReUse);
        convertParent(holder, getGroup(i),i);
        return holder.getConvertView();
    }
    @Override
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        MyViewHolderExpandbleListView holder = MyViewHolderExpandbleListView.get(mContext,view,viewGroup,mLayoutIdChild,i,mIsReUse);
