 ...
 */
public class A_LoginActivity_BandMobile extends MvpActivity<LoginPresent> implements View.OnClickListener, LoginView {
    ...
    protected int getLayoutId() {
        return R.layout.a_activity_login_bandmobile;
    }
