 ...
 */
public class A_Activity_DuShuHui_List extends MvpActivity {
    ...
    protected int getLayoutId() {
        return R.layout.a_activity_dushuhui_list;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String imgUrl1 = "http://47.92.221.41/image/a_dushuihui_list1.png";
        String imgUrl2 = "http://47.92.221.41/image/a_dushuhui_list2.png";
        String imgUrl3 = "http://47.92.221.41/image/a_dushuhuilist3.png";
        ...
        ImageView imageView3 = (ImageView) HuoDongLL3.findViewById(R.id.zhibo_item_bg);
        ...
        HuoDongLL1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), A_Activity_DuShuHui_XiangQing.class);
