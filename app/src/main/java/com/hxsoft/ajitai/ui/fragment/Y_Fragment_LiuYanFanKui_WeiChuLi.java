 ...
 */
public class Y_Fragment_LiuYanFanKui_WeiChuLi extends MvpFragment {
    ...
    protected int getLayoutId() {
        return R.layout.a_fragment_liuyanfankui_weichuli;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        WeiChuLi1LL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), A_Activity_LiuYanJianYi_XiangQing.class);
