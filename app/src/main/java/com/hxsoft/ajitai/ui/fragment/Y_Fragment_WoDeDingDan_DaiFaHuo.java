 ...
 */
public class Y_Fragment_WoDeDingDan_DaiFaHuo extends MvpFragment<A_Order_Present> implements A_Order_View {
    ...
    protected int getLayoutId() {
        return R.layout.a_fragment_wodedingdan_daifahuo;
    }
...
//        });
    ...
    private void getData() {
        ...
        presenter.orderPage(current, size, 1, getContext());
    }
