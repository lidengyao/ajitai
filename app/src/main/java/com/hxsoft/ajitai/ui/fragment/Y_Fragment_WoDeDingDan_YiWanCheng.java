 ...
 */
public class Y_Fragment_WoDeDingDan_YiWanCheng extends MvpFragment<A_Order_Present> implements A_Order_View {
    ...
    protected int getLayoutId() {
        return R.layout.a_fragment_wodedingdan_yiwancheng;
    }
...
//        });
    ...
    private void getData() {
        ...
        presenter.orderPage(current, size, 5, getContext());
    }
