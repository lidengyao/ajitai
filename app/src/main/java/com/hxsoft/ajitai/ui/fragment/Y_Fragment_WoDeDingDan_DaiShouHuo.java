 ...
 */
public class Y_Fragment_WoDeDingDan_DaiShouHuo extends MvpFragment<A_Order_Present> implements A_Order_View {
    ...
    protected int getLayoutId() {
        return R.layout.a_fragment_wodedingdan_daishouhuo;
    }
...
//        });
    ...
    private void getData() {
        ...
        presenter.orderPage(current, size, 2, getContext());
    }
